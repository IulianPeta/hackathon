...
class test_runs_m extends page_m
{
  ...
  function update(int $tr_id,int $tr_tst_id, string $tr_name,string $tr_runtime,int $tr_status,?string $tr_error_msg=null,?string $tr_error_type=null,?string $tr_sys_out=null,?string $tr_sys_err=null)
  {
    $param=[
      'tr_tst_id'=>$tr_tst_id,
      'tr_name'=>$tr_name,
